 ...
 */
const base =
  "h-[52px] rounded-3xl border-2 border-slate-900 flex items-center justify-center gap-1 text-base font-bold leading-none whitespace-nowrap shadow-[4px_4px_0_0_#0F172A]";
